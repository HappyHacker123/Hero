...
//							alert(dep[3])
							...
							temp = '<span id="root_span" style="font-family: PingFangSC-Semibold;font-size: 15px;font-weight: normal;font-stretch: normal;color: #000000;">' + res.root_cause + '</span>';
							$rootcause_div.append(temp);
							// down_msg  suggested_solution_div
							$solution_div = $('#suggested_solution_div');
							temp = '<span id="solution_span" style="font-family: PingFangSC-Semibold;font-size: 15px;font-weight: normal;font-stretch: normal;color: #000000;">' + res.solution + '</span>';
							$solution_div.append(temp);
              $project_info_div = $('#project_info_div');
              temp = '<span id="project_info_span" style="font-family: PingFangSC-Semibold;font-size: 15px;font-weight: normal;font-stretch: normal;color: #000000;">' + res.project_info + '</span>';
              $project_info_div.append(temp);
              // 绘制依赖图
						}
					}
				}
